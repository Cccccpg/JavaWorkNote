...
![image-20230331142513380](C:\Users\Acer\AppData\Roaming\Typora\typora-user-images\image-20230331142513380.png)

对象锁的的拥有者线程才可以执行 `monitorexit` 指令来释放锁。在执行 `monitorexit` 指令后，将锁计数器设为 0，表明锁被释放，其他线程可以尝试获取锁。整个流程与上面获取锁的流程相同。

![image-20230331142651178](C:\Users\Acer\AppData\Roaming\Typora\typora-user-images\image-20230331142651178.png)
...
![image-20230331150713518](C:\Users\Acer\AppData\Roaming\Typora\typora-user-images\image-20230331150713518.png)
